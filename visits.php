...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_submit'])) {
    ...
    try {
        ...
        if ($visit_type === 'food') {
            ...
            if ($money_visits_count >= 3) {
                throw new Exception("Money assistance limit reached. This household has received money assistance {$money_visits_count} times (limit: 3 times total).");
            }
